...
var imageData = {
  imageUrl:
    "https://www.uplers.com/wp-content/themes/uplers/assets/images/talent-profiles/NILEENA-1683129662.jpg",
...
var personalInfo = {
  name: "Nileena Ramesh ",
  description:
    "Diligent, adaptable professional Achieved success in project management and consistently meets deadlines. Excellent communication and leadership abilities.",
};
...
var rowData = [
  {
    imageUrl:
      "https://www.uplers.com/wp-content/themes/uplers/assets/images/talent-profiles/icon-aws.svg",
    skillName: "Terraform",
  ...
  {
    imageUrl:
      "https://www.uplers.com/wp-content/themes/uplers/assets/images/talent-profiles/icon-nginx.svg",
    skillName: "Ngnix",
    progressImage: "progress'.png",
    progressPercentage: "73%",
    detailsText: "View Assessments",
  ...
  {
    imageUrl:
      "https://www.uplers.com/wp-content/themes/uplers/assets/images/talent-profiles/icon-communication.svg",
    skillName: "AWS Cloud",
    progressImage: "progress'.png",
    progressPercentage: "73%",
    detailsText: "View Assessments",
  ...
  {
    imageUrl:
      "https://www.uplers.com/wp-content/themes/uplers/assets/images/talent-profiles/icon-DevOps.svg",
    skillName: "CI/CD",
    progressImage: "progress'.png",
    progressPercentage: "73%",
    detailsText: "View Assessments",
...
function createDynamicTable(data) {
  ...
  tableHtml += "<tr>";
  tableHtml +=
    '<td style="padding-right: 60px;"><p class="roleFont">Role</p></td>';
  tableHtml +=
    '<td style="padding-left: 60px;"><p class="roleFont">Years</p></td>';
  tableHtml += "</tr>";
...
function createDynamicContent(personalInfo) {
  var contentHtml = "<div>";
  contentHtml +=
    '<h1 class="font-bold h1Font pb-8">' + personalInfo.name + "</h1>";
  contentHtml += "</div>";
  contentHtml += '<div class="pb-8">';
  contentHtml += '<p class="text-sm">' + personalInfo.description + "</p>";
  contentHtml += "</div>";
...
function createDynamicSkillsets(skillsets) {
  ...
  skillsetsHtml += '<div class="dot-div-yellow z-10" >';
  skillsetsHtml +=
    '<div class="roleFont font-bold dot-div-yellow">Skillsets</div>';
  skillsetsHtml += "</div>";
  ...
  for (var i = 0; i < skillsets.length; i++) {
    skillsetsHtml += "<div>";
    skillsetsHtml +=
      '<button class="disabled-button text-sm" disabled>' +
      skillsets[i].skill +
      " - " +
...
function createDynamicSkillsSection(data) {
  ...
  outerDiv.classList.add("w-36");

  // Create the text element for "Vetted Skills"
  var textElement = document.createElement("p");
  textElement.classList.add("VettedFont");
  ...
  leftFlexItem.style.flex = "1 1 0%";
  leftFlexItem.classList.add("z-10"); // Added z-10 class
  ...
  rightFlexItem.style.flex = "6 1 0%";
  rightFlexItem.style.marginTop = "20px";
  rightFlexItem.classList.add("mt-8", "dot-div-yellow3");
...
createDynamicSkillsSection({ numberOfSkills: 3 });
...
function createDynamicProfessionalSummarySection(data) {
  ...
  var outerDiv = document.createElement("div");
  outerDiv.style.borderBottom = "1px solid rgb(0, 0, 0)";
  outerDiv.classList.add("w-36", "VettedFont");
  ...
  rightFlexItem.style.marginTop = "20px";
  rightFlexItem.classList.add("mt-8", "VettedFont");
...
function createDynamicMajorProjectsSection(data) {
  ...
  projectsTextElement.classList.add("mt-8", "dot-yellow5");
...
function createDynamicTableRows(data) {
  ...
  skillName.classList.add("text-base", "font-semibold", "pl-2");
...
function createDynamicExperienceSection(experienceData) {
  var container = document.createElement("div");
  container.classList.add("grid", "grid-rows-1", "grid-flow-col", "gap-1");
...
function createDynamicTechnologyCard(data) {
  ...
  cardContainer.className = "  flex flex-row gap-6";
